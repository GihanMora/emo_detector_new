...
if __name__ == '__main__':
    ...
    s_e = s_e.split('_')
    with open(r'E:\Projects\emo_detector_new\transcript_results\pros_all_meta_reports_lnm'+str(s_e[0])+'_'+str(s_e[1])+'.csv', mode='w',newline='',encoding='utf-8') as employee_file:
        ...
        i=0
        for each_file in pdf_list[int(s_e[0]):int(s_e[1])]:
            tt1 = datetime.now()
            i=i+1
